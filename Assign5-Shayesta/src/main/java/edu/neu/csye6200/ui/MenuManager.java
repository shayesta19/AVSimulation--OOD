...
public class MenuManager implements ActionListener {
	 ...
	 */
	public MenuManager(AVApp application) {
	 ...
	 */
	public MenuManager(AVApp application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(AVApp application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	class ExitAction extends AbstractAction {
		...
		protected ExitAction(AVApp application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(AVApp application) {
			super("AboutAction");
			this.application = application;
		}
